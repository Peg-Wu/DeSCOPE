...
output_dir="./results/descope/trainer_output/K562_ESSENTIAL"
tokenized_datasets_dir="/fse/home/wupengpeng/perturbation_data_origin/RNA/K562_ESSENTIAL/tokenized_dataset"
